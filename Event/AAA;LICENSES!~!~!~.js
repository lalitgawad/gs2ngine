...
var result = sendMeetingDetails("AddAgenda",MeetingModel.getMeetingBody(),MeetingModel.getStartDate(),MeetingModel.getStartTime(),agendaItem,capModel.getCustomID());
...
if(typeof result != "undefined")
{
	if(result[0] != "0000")
	{
		showMessage = true;
		cancel = true;
		comment("<font color=red><b>" + result[1] + "</b></font>");
	}
}

/*-----------------------------------------------------------------------------------------------------/
| LEGISTAR FUNCTION CALL END
/-----------------------------------------------------------------------------------------------------*/
