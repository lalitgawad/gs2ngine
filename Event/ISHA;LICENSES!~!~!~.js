...
try {
    ...
    logDebug("**WARNING: ISHA:LICENSES/*/*/*: #ID01-inspScheduleAuditLogAsyncWrapper:  " + err.message);
}
...
function inspScheduleAuditLogAsyncWrapper() {
    ...
    {
        logDebug("**WARNING: ISHA:LICENSES #ID02-inspScheduleAuditLogAsyncWrapper:  " + err.message);
    }
}
...
function sendInspectionScheduleEmail(){
	if (validateRecordTypeforScheduleEmailNotification()) {
		try {
			...
			logDebug("A JavaScript Error occurred: ISHA:LICENSES: " + err.message);
		}
	}
}
