...
try {
    ...
    logDebug("**WARNING: IRMA:LICENSES/*/*/*: #ID01-inspScheduleAuditLogAsyncWrapper:  " + err.message);
}
...
function inspScheduleAuditLogAsyncWrapper() {
    ...
    {
        logDebug("**WARNING: IRMA:LICENSES/*/*/*: #ID02-inspScheduleAuditLogAsyncWrapper:  " + err.message);
    }
}
