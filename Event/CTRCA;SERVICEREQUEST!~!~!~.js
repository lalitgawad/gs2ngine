...
try {
	...
	logDebug("A JavaScript Error occurred: CTRCA:SERVICEREQUEST/*/*/*: Creation of Documnet Conditions: " + err.message);
}
...
if (gpf.async_) {
	try {
		...
		logDebug("**WARNING: CTRCA:SERVICEREQUEST/*/*/*: #ID-asaCtrcaWrapper:  " + err.message);
	}
}
