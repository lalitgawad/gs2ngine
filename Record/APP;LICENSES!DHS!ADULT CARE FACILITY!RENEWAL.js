/**
 | Program : APP:LICENSES/DHS/ADULT CARE FACILITY/RENEWAL
 | Trigger : N/A
 | Event : N/A
...
/**
 Application Object for
  APP:Licenses/DHS/Adult Care Facility/Renewal
...
function APP_OBJ(identity, caller) {
    ...
    this.ObjId = "APP:Licenses/DHS/Adult Care Facility/Renewal";
    this.Id = identity;
    this.Caller = caller;
