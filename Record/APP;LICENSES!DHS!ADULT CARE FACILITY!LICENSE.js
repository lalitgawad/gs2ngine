/**
 | Program : APP:LICENSES/DHS/ADULT CARE FACILITY/LICENSE
 | Trigger : N/A
 | Event : N/A
...
/**
 Application Object for
  APP:Licenses/DHS/Adult Care Facility/License
...
function APP_OBJ(identity, caller) {
    ...
    this.ObjId = "APP:Licenses/DHS/Adult Care Facility/License";
    this.Id = identity;
    this.Caller = caller;
