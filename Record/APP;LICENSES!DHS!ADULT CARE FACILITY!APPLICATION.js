/**
 | Program : APP:LICENSES/DHS/ADULT CARE FACILITY/APPLICATION
 | Trigger : N/A
 | Event : N/A
...
/**
 Application Object for
  APP:Licenses/DHS/Adult Care Facility/Application
...
function APP_OBJ(identity, caller) {
    ...
    this.ObjId = "APP:Licenses/DHS/Adult Care Facility/Application";
    this.Id = identity;
    this.Caller = caller;
