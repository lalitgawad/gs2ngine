/**
 | Program : APP:LICENSES/DHS/CHILD CARE FACILITY/LICENSE
 | Trigger : N/A
 | Event : N/A
...
/**
 Application Object for
  APP:Licenses/DHS/Child Care Facility/License
...
function APP_OBJ(identity, caller) {
    ...
    this.ObjId = "APP:Licenses/DHS/Child Care Facility/License";
    this.Id = identity;
    this.Caller = caller;
