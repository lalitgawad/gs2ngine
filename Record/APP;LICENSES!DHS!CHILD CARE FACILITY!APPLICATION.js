/**
 | Program : APP:LICENSES/DHS/CHILD CARE FACILITY/APPLICATION
 | Trigger : N/A
 | Event : N/A
...
/**
 Application Object for
  APP:Licenses/DHS/Child Care Facility/Application
...
function APP_OBJ(identity, caller) {
    ...
    this.ObjId = "APP:Licenses/DHS/Child Care Facility/Application";
    this.Id = identity;
    this.Caller = caller;
